...
def open_url_in_chrome(url):
    ...
    for index, level_range in enumerate(li_bestiary_list):
        ...
        if last_page_check:
            final_bestiary_page_all_monsters_tables = driver.find_elements(by=By.CLASS_NAME, value='wikitable sortable align-center-1 align-left-2 align-left-3 align-center-4 align-center-5 align-center-6 align-center-7 align-center-8 align-center-9 jquery-tablesorter')
            for table in final_bestiary_page_all_monsters_tables:
